...
namespace geliosNEW
{
    class TCycleDoWhileDo : TBaseWorkShape
    {
        void CreateLines()
        {
            TArrowLine Line, Lnb;
            ...
            Rhomb = (TTfeRhombShape)(GetWorkShape(2));
        ...
        public TCycleDoWhileDo(int X, int Y, int Step, int NumberShape_Id, int Block_Id, int NumberLine_Id) : base(X, Y, Step, NumberShape_Id, Block_Id, NumberLine_Id) { }
