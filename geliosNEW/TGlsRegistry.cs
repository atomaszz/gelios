...
namespace geliosNEW
{
    class TGlsRegistry
    {
        string f_RegistryPath;
        string f_LocalPath;
 /*       TRegistry f_Registry;
    /*    string GetPath(string Name);
        public TGlsRegistry(HKEY AKey = SharedConst.HKEY_CURRENT_USER)
        {

        }
        ~TGlsRegistry() { }
   /*     public void SaveString(AnsiString Name, AnsiString Value);
        public string GetString(AnsiString Name);
