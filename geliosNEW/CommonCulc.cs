...
namespace geliosNEW
{
    class CommonCulc
    {
        ...
        public static int domin_S(string S1, string S2)
        {
            ...
            int[] n3 = new int[1024];
            int[] n4 = new int[1024];
            int[] n40 = new int[1024];
            int[] n30 = new int[1024];
            string p;
            ...
            for (I = 0; I < SharedConst.opt_sadacha.OptSovm.HiRow() + 1; I++)
            {
                for (J = 0; J < SharedConst.opt_sadacha.OptSovm.HiCol() + 1; J++)
                {
                    ...
                    if (((int)SharedConst.opt_sadacha.OptSovm.GetItems(I, J) != 0) && ((int)SharedConst.opt_sadacha.OptSovm.GetItems(I, J) == n4[J]))
                    { n40[J] = n4[J]; k1++; }
                }
    ...
    /*    int unpack_sostav(string S)
        {
            ...
            for (I = 0; I < SharedConst.opt_sadacha.OptSovm.HiRow() + 1; I++)
            {
                for (J = 0; J < SharedConst.opt_sadacha.OptSovm.HiCol() + 1; J++)
                {
                    if (SharedConst.opt_sadacha.OptSovm.Items[I][J] != 0) k++;
                    if ((SharedConst.opt_sadacha.OptSovm.Items[I][J] != 0) && (SharedConst.opt_sadacha.OptSovm.Items[I][J] == n3[J])) k1++;
                }
                if ((k1 != k) || (k == 0)) { k = 0; k1 = 0; continue; }
                else return 0;
            }
